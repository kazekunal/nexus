...
const SupportSection = () => {
  return (
    <section className="w-full py-8  bg-black text-white pb-32">
      <div className="max-w-6xl mx-auto px-8">
        <div className="flex flex-col md:flex-row gap-16 items-start">
          {/* Left column - Information */}
          <div className="w-full md:w-1/2 space-y-10">
            <h2 className="text-5xl font-extrabold leading-tight">Join Our Journey to Redefine Luxury Transportation</h2>
            ...
            <div className="pt-6">
              <h3 className="text-3xl font-semibold mb-4">Investment Opportunity</h3>
              ...
              <Link
            href="/support">
              <button className="mt-6 px-6 py-3 bg-white text-black font-bold rounded-lg hover:bg-gray-200 transition duration-300">
          ...
          <div className="w-full md:w-1/2 space-y-8">
            <h3 className="text-3xl font-semibold">Coming April 2025</h3>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="flex items-start gap-4">
                  <div className="p-3 bg-gray-800 rounded-full mt-1">
